(function () {
  ...
  var PRESETS = {
    ...
    'Up (med)':    { shape:'rise', hillLength:445, hillWidth:330, hillHeight:90,
                     bevelRun:80 },
    'Flat (med)':  { shape:'flat', hillLength:400, hillWidth:330, hillHeight:90,
                     bevelRun:80 },
    'Down (med)':  { shape:'fall', hillLength:445, hillWidth:330, hillHeight:90,
                     bevelRun:80 },
  ...
  var SHAPES = [
    ...
    { v:'rise',   label:'Module: up',
      hint:'Ground to full height, joined at the top so a flat or a down ramp ' +
           'goes straight on. A module climbs the whole height on its own, so ' +
           'use HALF the length of the roller you are matching \u2014 a 920 mm ' +
           'roller is up 445 + down 445, same slope and the same total cost.' },
    ...
    { v:'fall',   label:'Module: down',
      hint:'Full height back to the ground, joined at the top end. Same length ' +
           'rule as the up ramp: half the roller you are matching.' }
  ];
